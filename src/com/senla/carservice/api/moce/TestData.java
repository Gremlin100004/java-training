...
public class TestData {
    ...
    public ArrayList<String> getArrayMasterNames() {
    ...
    public ArrayList<String> getArrayGarageNames() {
        ArrayList<String> arrayName = new ArrayList<>();
    ...
    public ArrayList<String> getArrayAutomaker() {
        ArrayList<String> arrayName = new ArrayList<>();
        arrayName.add("lexus");
    ...
    public ArrayList<String> getArrayModel() {
        ArrayList<String> arrayName = new ArrayList<>();
        arrayName.add("LS");
        arrayName.add("A 200");
        arrayName.add("X6");
    ...
    public ArrayList<String> getArrayRegistrationNumber() {
        ArrayList<String> arrayName = new ArrayList<>();
    ...
    public ArrayList<BigDecimal> getArrayPrice() {
    ...
    public ArrayList<String> getArrayExecutionStartTime() {
    ...
    public ArrayList<String> getArrayLeadTime() {
        ArrayList<String> arrayDate = new ArrayList<>();
