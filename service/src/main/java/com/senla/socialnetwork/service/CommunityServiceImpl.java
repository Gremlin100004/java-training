...
public class CommunityServiceImpl implements CommunityService {
    ...
    public CommunityDto addCommunity(final CommunityForCreateDto communityDto) {
        return CommunityMapper.getCommunityDto(communityDao.save(CommunityMapper.getNewCommunity(
    ...
    public PostDto addPostToCommunity(final PostForCreationDto postDto, final Long communityId) {
        ...
        return PostMapper.getPostDto(postDao.save(PostMapper.getNewPost(postDto, community)));
    }
