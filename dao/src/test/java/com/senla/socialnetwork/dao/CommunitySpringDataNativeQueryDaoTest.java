...
import com.senla.socialnetwork.dao.springdata.CommunitySpringDataNativeQueryDao;
...
public class CommunitySpringDataNativeQueryDaoTest extends AbstractDaoTest {
    private static final int FIRST_RESULT = 0;
    private static final int MAX_RESULT = 10;
    private static final String TITTLE = "test";
    private static final String INFORMATION = "test";
    @Autowired
    private CommunitySpringDataNativeQueryDao communityDao;
    ...
    void CommunityDao_orderByCountBySubscribers() {
        List<Community> resultCommunities = communityDao.getCommunitiesSortiedByNumberOfSubscribers(PageRequest.of(FIRST_RESULT, MAX_RESULT));
        Assertions.assertNotNull(resultCommunities);
        Assertions.assertFalse(resultCommunities.isEmpty());
        Assertions.assertEquals(testDataUtil.getCommunitiesNotDelete().size(), resultCommunities.size());
