...
public class CommunityJdbcTemplateDaoImpl extends AbstractJdbcTemplateDao<Community, Long> implements CommunityDao {
    private static final String SQL_REQUEST_GET_COMMUNITIES = "SELECT communities.id, communities.creation_date, "
       ...
       + "user_profiles.name, user_profiles.surname FROM communities INNER JOIN user_profiles ON "
    ...
    private static final String SQL_REQUEST_GET_COMMUNITIES_SORTIED_BY_NUMBER_OF_SUBSCRIBERS = "SELECT communities.id, "
       + "communities.creation_date, communities.type, communities.is_deleted, communities.title, "
    ...
    private static final String SQL_REQUEST_FIND_BY_ID_AND_EMAIL = "SELECT communities.id, communities.creation_date, "
       ...
       + "AND users.email=?";
    private static final String START_FRAGMENT_REQUEST_SAVE_RECORD = "INSERT INTO communities (author_id, type, title, "
