...
(NULL, 1, '2020-07-11 10:00', '1990-07-28 03:45', 'Petya', 'Buhmetovich', '+375(29)766-54-23', 1, 1, 2007, 2, 2013),
(NULL, 2, '2020-08-11 10:00', '2004-11-12 03:45', 'Artem', 'Karchevskiy', '+375(29)467-34-62', 2, 3, '2007', 3, 2013),
(NULL, 3, '2020-09-11 10:00', '1996-03-21 03:45', 'Kiril', 'Myagkov', '+375(29)123-41-67', 3, 5, 2007, 4, 2013),
(NULL, 4, '2019-02-05 09:53', '2001-03-11 10:00', 'Vasya', 'Potryopovich', '+375(33)567-34-09', 4, 7, 2010,5, 2015);
...
(NULL, '2020-10-29 18:10', 'Очередные победы', 'Ольга Щукина в минувшее воскресенье пополнила коллекцию своих побед - она стала первой на Осеннем кроссе лыжников, проходившем близ деревни Борисово, что под Серпуховом. Оля бежала по лыжной трассе с очень непростым рельефом, суммарный набор высоты за выбранную Олей дистанцию в 5 километров составил аж 110 метров. Наша героиня прошедшей недели преодолела эту трассу за 25:59 и финишировала первой с более чем минутным отрывом от ближайшей преследовательницы! Мы поздравляем Олю и хотим радоваться её победам ещё и ещё!', 1, false),
(NULL, '2020-11-11 10:00', 'Нам сегодня пять лет!', NULL, 1, false);
