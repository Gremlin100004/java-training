...
public class UserProfileTestData {
    ...
    public static UserProfile getTestUserProfile() {
        ...
        userProfile.setLocation(LocationTestData.getLocation());
    ...
    public static UserProfileDto getUserProfileDto() {
        ...
        userProfileDto.setLocation(LocationTestData.getLocationDto());
        userProfileDto.setSchool(SchoolTestData.getSchoolDto());
        userProfileDto.setUniversity(UniversityTestData.getUniversityDto());
