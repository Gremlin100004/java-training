...
public class UserTestData {
    ...
    public static UserForSecurityDto getUserForSecurityDto() {
    ...
    public static List<UserForAdminDto> getUsersForAdminDto() {
    ...
    public static List<UserForSecurityDto> getUsersForSecurityDto() {
        UserForSecurityDto userDtoOne = getUserForSecurityDto();
        UserForSecurityDto userDtoTwo = getUserForSecurityDto();
