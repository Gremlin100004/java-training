...
public class PostTestData {
    ...
    public static PostDto getPostDto() {
        ...
        postDto.setCommunity(CommunityTestData.getCommunityDto());
        return postDto;
    }

    public static PostForCreationDto getPostForCreationDto() {
    ...
    public static List<PostDto> getPostsDto() {
        PostDto postDtoOne = getPostDto();
        PostDto postDtoTwo = getPostDto();
