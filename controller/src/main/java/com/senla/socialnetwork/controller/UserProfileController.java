...
public class UserProfileController {
    ...
    public static final String RETURN_LIST_OF_USER_PROFILES_OK_MESSAGE = "Successfully retrieved list of users profiles";
    public static final String RETURN_USER_PROFILE_OK_MESSAGE = "Successfully retrieved user profile";
    public static final String RETURN_LIST_OF_PRIVATE_MESSAGES_OK_MESSAGE = "Successfully retrieved list of private messages";
    ...
    public static final String GET_USER_PROFILES_DESCRIPTION = "This method is used to get users profiles. Users profiles can be filtered by age, university, school or location";
    public static final String UPDATE_USER_PROFILE_DESCRIPTION = "This method is used to update the profile of a given user";
    public static final String GET_SORT_USER_PROFILES_DESCRIPTION = "This method is used to get users profiles. Users profiles can be sorted by surname or registration date";
    public static final String GET_FRIEND_NEAREST_DATE_OF_BIRTH_DESCRIPTION = "This method is used to get a friend who will have a birthday soon";
    ...
    public static final String GET_SORTED_FRIENDS_OF_USER_PROFILE_DESCRIPTION = "This method is used to get friends profiles. Friends profiles can be sorted by birthday, name or number of friends";
    public static final String GET_USER_PROFILE_SIGNED_FRIENDS_DESCRIPTION = "This method is used to get a list of friends subscribed to this profile";
    ...
    public static final String REMOVE_USER_FROM_FRIENDS_DESCRIPTION = "This method is used to remove a user from friends";
    public static final String DELETE_USER_PROFILE_DESCRIPTION = "This method is used to delete a record from the database by the admin";
    public static final String GET_PRIVATE_MESSAGES_DESCRIPTION = "This method is used to get private messages of this user";
    ...
    public static final String GET_FRIENDS_PUBLIC_MESSAGES_DESCRIPTION = "This method is used to get public messages of friends";
    public static final String GET_PUBLIC_MESSAGES_DESCRIPTION = "This method is used to get public messages of a given user";
    @Autowired
